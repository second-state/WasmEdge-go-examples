...
func main() {
	...
	// Expected Args[0]: program name (./mobilenet_plants)
	// Expected Args[1]: wasm or wasm-so file (rust_mobilenet_plants_lib_bg.wasm)
	// Expected Args[2]: input image name (sunflower.jpg)
